...
describe("invokeDoubleTapAction", () => {
  ...
  let mockData: DoubleTapData;
  let mockCallback: Mock<
    | ((...arguments_: [PointerEvent, DoubleTapData]) => boolean)
    | ((...arguments_: [PointerEvent, DoubleTapData]) => void)
  >;
  ...
  describe("callback invocation", () => {
    it("should invoke the callback with event direction and data", () => {
      invokeDoubleTapAction(mockEvent, mockData, mockCallback, {});
